...
--
/*!50003 DROP FUNCTION IF EXISTS `vehiculos_disponibles` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `vehiculos_disponibles`() RETURNS int
    DETERMINISTIC
BEGIN
    DECLARE total INT;
